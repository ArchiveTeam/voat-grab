...
LUA_SHA1 = get_hash(os.path.join(CWD, 'voat.lua'))
...
class WgetArgs(object):
    def realize(self, item):
        wget_args = [
            ...
            '--warc-header', 'voat-dld-script-version: ' + VERSION,
            '--warc-header', ItemInterpolation('voat-item: %(item_name)s'),
...
project = Project(
    title = 'voat',
    project_html = '''
    <img class="project-logo" alt="logo" src="https://archiveteam.org/images/6/61/Voat-logo.png" height="50px"/>
    <h2>voat.co <span class="links"><a href="https://voat.co/">Website</a> &middot; <a href="http://tracker.archiveteam.org/voat/">Leaderboard</a></span></h2>
    '''
)
...
pipeline = Pipeline(
    ...
    GetItemFromTracker('http://%s/%s' % (TRACKER_HOST, TRACKER_ID), downloader,
        VERSION),
    PrepareDirectories(warc_prefix='voat'),
    WgetDownload(
        WgetArgs(),
        max_tries=1,
